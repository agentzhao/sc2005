...
void SimpleThread(_int which) // 'which' tells you which thread, for debugging
{
  int num;
...
void ThreadTest() {
  ...
  Thread *t1 =
      new Thread("child1"); // thread constructor does minimial initialization
  t1->Fork(SimpleThread, 1,
           0); // allows thread to be able to be scheduled & excuted by CPU
